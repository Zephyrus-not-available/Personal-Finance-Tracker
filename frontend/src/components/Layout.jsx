...
export default function Layout() {
	...
	return (
		<div className="flex min-h-screen w-full bg-[#09090b] text-white font-sans selection:bg-cyan-500/30">
			{/* Mobile Header & Nav */}
			<div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-[#09090b]/80 backdrop-blur-xl border-b border-white/5 z-50 flex items-center justify-between px-4">
			...
			{/* Mobile Drawer */}
			{mobileMenuOpen && (
				<div className="md:hidden fixed flex flex-col inset-0 z-40 bg-[#09090b]/95 backdrop-blur-md pt-20 pb-6 px-4">
			...
			{/* Desktop Sidebar */}
			<aside className="hidden md:flex w-64 bg-[#121214] border-r border-white/5 sticky top-0 h-screen z-10 flex-col py-8 px-4">
							...
							<li key={item.path}>
								<Link
									...
									className={cn(
										...
										isActive
											? 'bg-white/10 text-white shadow-[0_0_12px_rgba(255,255,255,0.03)] backdrop-blur-md border border-white/5'
											: 'text-slate-400 hover:bg-white/5 hover:text-slate-200'
									)}
								>
									<Icon className={cn(
				...
				<div className="mt-auto px-2 pt-8 border-t border-white/5">
					<div className="flex items-center gap-3 relative z-20">
						<div className="w-8 h-8 rounded-full bg-[#09090b] border border-white/10 flex items-center justify-center text-sm font-semibold text-slate-300">
							U
						</div>
			...
			<main className="flex-1 flex flex-col pt-16 md:pt-0 min-h-screen">
				<div className="w-full max-w-[1400px] mx-auto flex flex-col flex-1 h-full">
					<Outlet />
				</div>
			</main>
		</div>
